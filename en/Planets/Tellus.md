...
| Radius | 6,371 Km <!--Same as earth--> |
| Orbit Radius | 149,600,000 Km (149.60 million kilometers) <!--Needs recomputation based on two star model--> |
| Location | Tellus is in the Sol System, which is in CSU. |

<!--Note: For more design-time information, see Star Manager. (Remark, #20221120) Star Manager was no longer a thing; So it's either this Wiki, or RTS?-->

## Names and Etymology

<!--Pending elaboration then we can move part of this into Tellurian repo Etymology folder-->

* The word "Tellus" comes from Greek word for "earth". <!--Pending modifications-->
...
* Tellurian 1 - Archetype : Homo Sapiens <!--Notice we use the English word as is-->; "智人"
* Tellurian 2 - Archetype: Home Erectus <!--Notice we use the English word as is-->; "高地人"
...
There are in the modern world 2 major types of tellusoid on Tellus: 高地人和智人。高地人起先在北艾发现，后来分为南方高地人和北方高地人；高地人体格健大，北高地人适应严寒天气、肤色偏白，南高地人适应炎热天气，肤色偏黑——双方互相看不起，冲突矛盾很大，是除了与智人的矛盾之外相互之间最大的矛盾。其中南方高地人在赤道附近的太平洲聚集比较多所以又称平川人（话说所有的人都可能是先在南艾发生）——平川人的地区是上古文明，<!--类似埃及地区尼罗河流域-->其祖先建造了金字塔，位于赤道而农业发达、民风淳朴大方泼辣，有些地方四季都能种植，由于向来精于计算和经商、天文，到了当代则是文化十分发达。

南北高地人是相互之间完全不沟通的——北高地人是共产主义，南高地人是资本主义。其中智人被夹在南北高地人之间。泰勒斯上的冲突主要是西方和中方文化的冲突，自由民主和共产主义的冲突，以及两大人种和南北高地人之间的冲突——冲突并非两极化：类似当今internalization世界，这种冲突是公存互利关系和历史差异之间的冲突。<!--(PENDING) PENDING CONSOLIDATION: Do it in one additional pass (I am running out of time otherwise I will do it now and not link the webpage) - We can take some meanings from those interpretations of the naming of things: https://zhidao.baidu.com/question/16562396.html. No need to otherwise collect that webpage fully. Similarly, refer and re-collect the text on 灌溉、农业发达 of the 平川地区：https://www.sohu.com/a/330874620_100098218.-->
...
The racial difference between T1 and T2 is a long-lasting issue and cause of conflict within the T2 Tellurian species. As in in our world, the other tellurian species (Homo Cavernas) are closest long-distinct species (will be known as Medalians). <!--Notice it's still an open question whether Medalians originate from Earth or are spontaneous creations of the universe-->
...
#### Tribes and First Nations/People (Aboriginals)
...
因为太阳系有8个重要的星体（包括太阳和月亮），所以从古代巴以太人流传下来直到现代历法，每周8天<!---Per Babylon and why there are 7 days in our modern calendar.-->。
纪年历法名称叫做“大纪元”，例如“大纪元5000年“。不过这个名字虽然响亮但是与现实中entity有冲撞而且不是intentional的，所以如果有alternative的话考虑修改。

### Continents

泰勒斯上有六大洲五大洋：<!--(5+1) continents-->

* Axia, which is divided into north and south <!--(艾克西亚)（腓尼基人起名/闪米特语）（艾洲）分为南北: Northern Axia and Southern Axia-->
* Ereb <!--(以拉伯, 以洲)-->
* Arphyria <!--(阿飞利亚洲, 飞洲)-->
* Audas <!--(Latina, 拉丁美洲, 美洲, 奥达洲)-->
* The Occina/Occinica <!--(太平洲/大河洲) - In the middle of the southern sea-->

### Oceans

There are five major oceans on Tellus:

* The Great Northern Ocean - The Caelestis <!--The Heavenly/Mystical Sea-->
* The Great Southern Ocean - The Frozen Sea, The Gledia/Gladia <!--(from latin Gelida)-->
* The Great Western Ocean - Treasure Ocean, The Odentis <!--(from Occidentis)-->
* The Hanudian Ocean: West of southern hemisphere <!--Or "Resic Ocean" in the north of eastern hemisphere (or southern hemisphere)-->
* Pearl Ocean in the east southern hemisphere <!--Or south of eastern hemisphere, or southern hemisphere, or east of southern hemisphere)-->
...
* 3000.08.05 The Medieval Times. Tags: Our World. Time: 450 yr. The Medieval time is filled with anger, fear, uncertainty, tormented by wars, dark magic and wizzadry.
...
* 2016.07.01 The Couryard of Turtle Tiled Glass Started Construction. Tags: NFC, Tao Ye, #Catherine Leng.
    * Consider moving to NFC specific wiki entry.
* 2018.09.01 The Couryard of Turtle Tiled Glass Finished Construction. Tags: NFC, Tao Ye, #Catherine Leng
    * Consider moving to NFC specific wiki entry.
...
* Waves of Kruk Invasion: <!--Pending archive as #deprecated-->~~The first wave of **Kruks** invading and coming at Miah *made humans cautious and overly suspicious*. Eventually Miah is driven out of the Earth upon pressure - this is where **The Great War** begins (it's great because it made us realize how small we truly are) - it's barely an equal fight since Kruks have total dominance, but there is severe struggle and resistance.~~ <!--Pending archive as #deprecated-->~~Two Nukes, among others elsewhere, landed on **Vancouver** and **Toronto**. There was a **total nuclear war** and *the planet is wasted beyond recognition* - it leaves us with a *post-apocalyptic world*. <!--Can we settle on how many years did the total war last?-->~~ <!--TODO: Pending reconciliation of exact order of events between Miah and Kruk species arriving on earth; Order of events for Queen Six and Queen Seven.-->
...
* T5035.06: Eleven Baker's Celebration Party. Tag: Eleven Baker. (note) <!--Maybe it's Eleven's publisher that sold her because when she leaves Tellus there is practically no value of her to the corp; And instead of paying the expensive space travel funding, they can just make a false promise and instead of spending money they actually gain money by sell her to some space agencies. We must question can a publisher be so evil? Maybe not - but they can be very CARELESS (maybe intentionally) - so what they did is they find some interstellar agencies (or such agencies found them) and made a deal, assuming/pretending that this agency will take care of Eleven - to sort of make her as the new pop-star of a distant galaxy, and sold her contract. In fact, this can be made even explicit and to the public as a way to further clear off the responsibilities: the three parties including Eleven Baker, the original publisher, and the new agency signed a deal, transferring Eleven's contract from Tellus to some distant galaxy, and they make it a big news that Eleven will now seek new career development in a new distant galaxy. What is NOT public is that the original publisher/agency actually received a large amounts of bonus (bribe) money from this out-of-no-where space talen-acquisition agency. Medai does all the work of shaping such a positive image: it's all adversisement, because seriously, how would Tellurian people ever know whether this space agency is legit at all?! They don't, and that's where everyone is so hyped and careless. One thing we must do before make this idea final: Check the status of Miah regulation on such illicit acitivites on Tellus - are their regulation at all since Miah people has absolutely no soverignty on Tellus and Tellurian governments knows absolutely shit about Medalian world?--> (note) <!--Above along with all the celebration details of the party, some depiction of personal life and emotional background of Eleven Baker, and coverage of media can be made into a single chapter: The Party.-->
* T5035.09: Eleven Leaving Tellus.
* T5036: (People name) 勾结敌国. Tag 张鹤 高聪 TNE. (discuss) What is the need for TNE to do this? What's the use of abundant human slavery? It can't boldly just use those. (The only plausible reason is not that it reflects the need of the country as a whole - but is merely a result of internal government corruption and how such trades benefits the few/many government officials by allowing it to happen and even encouraging it, e.g. monetarily or sexually). (note) It might be around this time when Aa Mu's brother was sent to outer space.
...
* T5041: Kun VI Came to Tellus. (note) Question: Why does it take her so long to come? Why not immediately receive the message from Kun VII? <!--Unless it take the message an equal amount of time to travel just like it takes time to teleport people, even if the message doesn't require Startgate level energy to transmit.-->
...
Here are the few types of information of interest on the country level:
