...
* (Civil, GIS) NFC has 4 city halls<!--Ideally we break this down into and according to suburbs-->: **Area 1 City Hall**, **Area 6 City Hall**, **Area 12 City Hall**, and **Area 18 City Hall**. <!--Instead of having city halls, since NFC is likely highly digitalized, why doesn't every one (or every other nearby) area has its own "city-hall" like general public service (like "Service Ontario") center? So instead of calling it "city hall", we call it "NFC Service Center".-->
...
* (Infrastructure, City, Element) Info Booth: CofN library operated small information booth with AI Robot and some magazines to read. It's an search engine and also something for people to interact with in general.
